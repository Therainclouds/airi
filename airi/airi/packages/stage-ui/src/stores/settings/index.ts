...
import { useSettingsVision } from './vision'
...
export const useSettings = defineStore('settings', () => {
  ...
  const vision = useSettingsVision()
  ...
  const visionRefs = storeToRefs(vision)
  ...
  return {
    ...
    // Vision settings
    cameraFrameEnabled: visionRefs.cameraFrameEnabled,
    cameraFrameAutoGreetingEnabled: visionRefs.cameraFrameAutoGreetingEnabled,
    cameraFrameAutoCaptureIntervalMs: visionRefs.cameraFrameAutoCaptureIntervalMs,
    cameraFrameAutoSendEnabled: visionRefs.cameraFrameAutoSendEnabled,
    cameraFrameAutoSendDelayMs: visionRefs.cameraFrameAutoSendDelayMs,
