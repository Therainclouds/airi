...
chatHookCleanups.push(onBeforeMessageComposed(async () => {
  ...
  setupAnalyser()
  await setupLipSync()
  if (narrationEnabled.value && activeSpeechProvider.value) {
    void providersStore.getProviderInstance(activeSpeechProvider.value).catch(() => {})
  }
  startIdleHeadWave()
